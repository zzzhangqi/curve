...
int DiskCacheWrite::UploadAllCacheWriteFile() {
    ...
    std::function<void(const std::string &path, std::vector<std::string> *cacheObj)> listDir;
    listDir = [&listDir ,this](const std::string &path, std::vector<std::string> *cacheObj) {
        DIR *dir;
        struct dirent *ent;
